    ...
    <body style="width:99%;height:100%;">
        <div class="container">
            ...
            <article>
                ...
                <input class=cov1 type="button" onclick="window.location.href='Customer.jsp'" value="Home" style="width:70px;height:70px;margin-left: 20px;text-align: center">
                
                <br><br><br>
                <iframe src="cart.jsp" style="width: 100%;height:430px;border:1px solid white;margin-top: 0px;">
                </iframe>
